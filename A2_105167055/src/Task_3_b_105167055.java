...
public class Task_3_b_105167055 {
	...
	public static void main(String[] args) {
		...
		System.out.println("Please Enter your choice to sort 100000 random strings each of length 4(10 times): ");
	...
	static public void sortArray(int choice) {
		...
		System.out.println("The average CPU time taken to sort 100000 random Strings each of length "
				+ STRING_LEN + " for " + tempString + " is " + (totalTime/RECORDS) + " nanoseconds");
	}
