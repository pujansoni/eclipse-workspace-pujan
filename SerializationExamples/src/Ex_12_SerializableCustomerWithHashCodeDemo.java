...
public class Ex_12_SerializableCustomerWithHashCodeDemo {
	public static void main(String[] args) {
		// TODO Auto-generated method stub
		// create an customer object 
		Ex_12_SerializableCustomerWithHashCode serializeCustomer = Ex_12_SerializableCustomerWithHashCode.getInstance();
        ...
        Ex_12_SerializableCustomerWithHashCode deSerializeCustomer = null;
        try {
            ...
            deSerializeCustomer = (Ex_12_SerializableCustomerWithHashCode) ois.readObject();
            ois.close();
