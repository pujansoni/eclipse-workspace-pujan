...
// In the postman to PUT(update) data we use the PUT method in post man and select body and raw and type to JSON and supply our update value at the url: localhost:8080/api/employee.
// The JPA classes is extended by the EmployeeDAO class in this example