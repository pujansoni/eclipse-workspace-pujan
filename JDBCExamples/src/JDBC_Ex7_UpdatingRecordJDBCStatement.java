...
public class JDBC_Ex7_UpdatingRecordJDBCStatement {
	...
	public static void main(String[] args) {
		...
		try {
			...
			String sqlUpdateQuery = "UPDATE PLAYER SET AGE = 47 WHERE PLAYER_ID = 1";
			//Step 2.C: Executing SQL & retrieve data into ResultSet
			int sqlQueryResult = statement.executeUpdate(sqlUpdateQuery);
